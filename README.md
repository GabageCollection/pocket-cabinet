...
| 数据 | 数量 |
| --- | --- |
| 系统配方 | **90 款**（72 款 IBA 官方 + 16 款经典 + 2 款家庭简化；数据版本 2026.09.05） |
| 材料 | 81 种 |
| 替代规则 | 13 条（单层、有方向、含比例/风味影响/适用方法/优先级） |
| 品牌记录 | 20 条 |

⚠️ 规格目标为 150 款，**当前 90 款未达标**。本批新增 71 款为 IBA 官方配方表与常见经典，
用量按通行版本（IBA 规格表及公认配方）编写；无法联网逐条二次核验的部分在 GAPS.md 中说明，
未宣称满足 150 款验收要求。扩充到 150 款时只需向 recipes.json 追加并通过完整性校验。
